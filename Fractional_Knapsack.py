class Item:
    def __init__(self, weight, value): self.weight = weight, self.value = value, self.value_per_weight = value / weight

    def __lt__(self, other): return self.value_per_weight < other.value_per_weight
